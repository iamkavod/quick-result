...
export default function Header30() {
  return (
    <header className="relative wrapper !bg-[#edf2fc] my-1">
      <nav className="navbar navbar-expand-lg center-nav navbar-light navbar-bg-light !bg-[#ffffff]">
          ...
          <div className="navbar-other w-full !flex !ml-auto">
            <ul className="navbar-nav !flex-row !items-center !ml-auto">
              <li className="nav-item hidden xl:block lg:block md:block">
                <Link href={`/contact`} className="btn btn-sm btn-navy">
                  Contact Me
                </Link>
              </li>
