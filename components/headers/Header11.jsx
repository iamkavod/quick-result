...
export default function Header11() {
  return (
    <header className="relative wrapper !bg-[#ffffff]">
      <div className="bg-[rgba(52,63,82)] !text-white font-bold text-[.75rem] !mb-2">
