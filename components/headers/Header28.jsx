    ...
    <header className="!absolute w-full">
      ...
      >
        <div className="container py-2 !text-center">
          <p className="!mb-0">
            ✨ Sandbox is part of Envato's Biggest Sale to date, be quick and
            grab a
            <a href="#" className="!text-white hover inline-flex items-center">
              copy
              <i className="uil uil-arrow-right text-[0.8rem] before:content-['\e94c']" />
            </a>
          </p>
        </div>
        {/* /.container */}
