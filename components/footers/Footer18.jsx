...
export default function Footer18() {
  return (
    <footer className="bg-[rgba(52,63,82)] opacity-100 !text-[#cacaca]">
      <div className="container pt-14 xl:pt-6 lg:pt-6 pb-16 xl:pb-20 lg:pb-20 md:pb-20">
        <div className="xl:!flex lg:!flex flex-row xl:!items-center lg:!items-center">
          <h3 className="xl:!text-[2.1rem] !text-[calc(1.335rem_+_1.02vw)] !leading-[1.2] !mb-6 lg:!mb-0 xl:!mb-0 xl:!pr-40 lg:!pr-40 xxl:!pr-[22.5rem] !text-white">
            Join our community by using our services and grow your business.
          </h3>
          <a
            href="#"
            className="btn btn-sky !text-white !bg-[#5eb9f0] border-[#5eb9f0] hover:text-white hover:!bg-[#5eb9f0] hover:!border-[#5eb9f0] focus:shadow-[rgba(88,167,216,1)] active:text-white active:!bg-[#5eb9f0] active:border-[#5eb9f0] disabled:text-white disabled:!bg-[#5eb9f0] disabled:border-[#5eb9f0] !rounded-[50rem] !mb-0 whitespace-nowrap"
          >
            Try It For Free
          </a>
        </div>
        ...
        <div className="flex flex-wrap mx-[-15px] !mt-[-30px] xl:!mt-0 lg:!mt-0">
          ...
          <div className="md:w-4/12 xl:w-3/12 lg:w-3/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!mt-0 lg:!mt-0 !mt-[30px]">
            <div className="widget !text-[#cacaca]">
              ...
              <a
                className="!text-[#cacaca] hover:!text-[#5eb9f0]"
